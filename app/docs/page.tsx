      ...
      <VStack spacing={5} align="stretch">
        ...
        <Box id="introduction">
          ...
          <Text>
            ...
            提供组网联机服务的服务器，说人话就是整着玩的不求盈利。如果看不懂使用教程或不会用，可尝试加QQ交流群寻求帮助，也可以赞助10元找服主一对一教学
            <Link
              ml={1}
              color="#7dfffe"
              fontWeight="bold"
        ...
        <Box id="issues">
          ...
          <VStack spacing={2} align="stretch">
            ...
            <Text>
              ...
              <br />
              答：本服务器并不面向海外玩家，可能会被中国大陆防火墙拦截流量或因网络质量差丢包等，所以海外玩家使用喵服联机可能会卡顿甚至无法在线，如有需要请找服主购买海外专用服务器，价格一个月30元左右，具体看地理位置。
            </Text>
