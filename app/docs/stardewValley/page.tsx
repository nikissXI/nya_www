    ...
    <Center>
      ...
      >
        ...
        <List spacing={3} mt={5}>
          ...
          <ListItem>
            <ListIcon as={MdTipsAndUpdates} />
            <Text as="span" color="#ffca3d">如果都在线仍然加入失败，检查这些点</Text>
            <br />
            1、手机或平板做主机时，客机加入时，主机游戏不能放后台，放后台游戏房间将无法被搜索到
            <br />
            2、如果是苹果设备需要给星露谷网络权限
            <br />
            3、主机大退游戏重新主持农场（大退的意思：完全退出游戏再重新打开游戏），这是游戏的bug，主机有概率卡bug其他无法加入，一次不行就继续大退，多试几次
            <br />
            4、尝试换一个人做主机（即主持农场），或新建一个农场试试
            <br />
            5、使用下方的查房功能，每个玩家都主持一次农场，测试农场是否能被搜索，谁的农场搜不到就是谁的问题，查的时候目标游戏不要放后台！建议让另一个人去查（除非你是电脑）
          </ListItem>
        </List>
