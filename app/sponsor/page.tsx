      ...
      <VStack spacing={3}>
        ...
        <List spacing={2}>
          ...
          <ListItem textAlign="left">
            ...
            2026年7月11日开始，赞助专用节点仅需房主赞助，加入房间不需要赞助，但房间人数有上限。
            <HighLight>
              10元解锁的节点，累计赞助10元时房间最大人数为2，满20元时为3。可以简单理解为每多10元多1人。
            </HighLight>
            跨境节点则累计赞助20元时为2，满40元时为3
            <br />
            计算公式：房间最大人数 = 累计赞助费用 // 节点解锁费用 +
            1。并且多个赞助者在同一房间可叠加，最大8
          </ListItem>
